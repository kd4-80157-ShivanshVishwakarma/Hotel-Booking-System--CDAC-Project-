...
namespace RepositoryLib
{
    public class RoleRepository : IRoleRepository
    {
        ...
        private static String? _ConnectionDetails = @"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=ErrorDB2;Integrated Security=True";
        ...
        public bool CreateRole(string roleName)
        {
            ...
            SqlCommand command = new SqlCommand("spInsertRole", connection);
        ...
        public int getRoleByEmail(string emailId)
        {
            SqlConnection connection = new SqlConnection(_ConnectionDetails);
            connection.Open();

            string query = "select RoleId from T_User where EmailId=@emailId";
            SqlCommand command = new SqlCommand(query, connection);
