...
function AddRoomForm() {
    ...
    const [roomData,setRoomData] = useState({roomCatagoryId:"1",totalRooms:"",roomPrice:"",hotelId:"7"}); 
    ...
    const url="http://localhost:5024/room/addRoom";
    const addRoom = async ()=>{
    ...
    return ( 
        <div className="container">
            <form onSubmit={handleSubmit}>
                ...
                <div className="col-lg-4 offset-lg-4 btn-space btn-space text-center" >
